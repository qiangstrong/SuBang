...
public class RegionController extends BaseController {
	...
	public ModelAndView modifyCity(City city){
		ModelAndView view = new ModelAndView();
		boolean isException = false;
		try {
	...
	public ModelAndView addDistrict(District district){
		ModelAndView view = new ModelAndView();
		boolean isException = false;
		try {
	...
	public ModelAndView deleteDistrict(HttpSession session, @RequestParam("districtids") String districtids){
		ModelAndView view = new ModelAndView();
		boolean isException = false;
	...
	public ModelAndView modifyDistrict(District district){
		ModelAndView view = new ModelAndView();
		boolean isException = false;
		try {
	...
	public ModelAndView listRegion(HttpSession session,@RequestParam("districtid") Integer districtid){
		ModelAndView view = new ModelAndView();
	...
	public ModelAndView deleteRegion(HttpSession session, @RequestParam("regionids") String regionids){
		ModelAndView view = new ModelAndView();
		boolean isException = false;
	...
	public ModelAndView modifyRegion(Region region){
		ModelAndView view = new ModelAndView();
		boolean isException = false;
		try {
