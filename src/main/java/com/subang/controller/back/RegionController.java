...
public class RegionController extends BaseController {
	...
	public ModelAndView deleteDistrict(HttpSession session,
		...
		view.setViewName("redirect:"+WebConst.BACK_PREFIX+"/region/district.html?cityid=" + city.getId());
		return view;
	}
	...
	public ModelAndView deleteRegion(HttpSession session,
		...
		view.setViewName("redirect:"+WebConst.BACK_PREFIX+"/region/region.html?cityid=" + district.getId());
		return view;
	}
