...
<head>
	...
	<script>
		function deleteRegions() {
			...
			if (regionids) {
				var url = "region/deleteregion.html";
...
<body>
	...
	<table align="center">
		<tr>
			<td>${desMsg}</td>
			<td align="right"><a href="<c:url value="/region/district.html?cityid=${cityid}"/>">返回</a></td>
		</tr>
		<tr>
			<td align="right" colspan="2"><a href="<c:url value="/region/showaddregion.html?districtid=${districtid}"/>">添加小区</a></td>
		</tr>
		<tr>
			...
			<table border="1" cellpadding="5">
					...
					<c:forEach var="region" items="${regions}">
						<tr>
							...
							<td>${region.name}</td>
							<td>
								<a href="<c:url value="/region/showmodifyregion.html?regionid=${region.id}"/>">修改</a>
							</td>
						</tr>
					</c:forEach>
				</table>
