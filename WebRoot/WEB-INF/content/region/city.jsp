...
<body>
	...
	<table align="center">
		<tr>
			<td align="right" colspan="2"><a href="region/showaddcity.html">添加城市</a></td>
		</tr>
		<tr>
			...
			<table border="1" cellpadding="5">
					...
					<c:forEach var="city" items="${citys}">
						<tr>
							...
							<td>${city.name}</td>
							<td>
								<a href="<c:url value="/region/district.html?cityid=${city.id}"/>">区</a>
							</td>
							<td>
								<a href="<c:url value="/region/showmodifycity.html?cityid=${city.id}"/>">修改</a>
							</td>
						</tr>
					</c:forEach>
				</table>
