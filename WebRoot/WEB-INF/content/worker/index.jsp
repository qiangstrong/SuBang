	...
	<table align="center">
		<tr>
			<td align="right" colspan="2">
				<a href="worker/list.html">所有工作人员</a>
				<a href="worker/showadd.html">添加新工作人员</a>
			</td>
		</tr>
		<tr>
			<td>
				<form name="searchArg" action="worker/search.html" method="post">
					类别：
			...
			<table border="1" cellpadding="5">
					...
					<c:forEach var="worker" items="${workers}">
						<tr>
							...
							<td>
								<a href="<c:url value="/worker/area.html?workerid=${worker.id}"/>">区域</a>
							</td>
							<td>
								<a href="<c:url value="/worker/showmodify.html?workerid=${worker.id}"/>">修改</a>
							</td>
						</tr>
					</c:forEach>
				</table>
