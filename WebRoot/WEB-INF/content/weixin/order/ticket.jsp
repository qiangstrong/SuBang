...
<title>我的优惠券</title>
<link href="css/weixin/ccsjsp/activity/base.css" rel="stylesheet"
	type="text/css">
<link href="css/weixin/ccsjsp/activity/card.css" rel="stylesheet"
	...
	<section id="main">
		<div class="recommend single-row">
			<c:forEach var="ticketDetail" items="${ticketDetails}">
				<a
					href="weixin/order/parapay.html?orderid=${orderid}&ticketid=${ticketDetail.id}">
					<div class="item">
