...
<body id="card" ondragstart="return false;"
	...
	<div class="card" id="icard">
		<img src="css/weixin/ccsjsp/user/index/center_banner.png"
			class="card-bg-card"> <img
			src="css/weixin/ccsjsp/user/index/avatar.png" class="subang_logo">
		<div class="loginInfo">
			${user.cellnum} <a href="weixin/balance/parapay.html"
				class="link-chongzhi" style="padding:5px 0;"> 充值 <img alt=" "
				src="css/weixin/ccsjsp/user/index/chongzhi_jt.png"> </a>
			<p>我们只做最专业的品质服务</p>
		</div>
	</div>
	<nav class="main-nav white-bg">
		<div class="subnav">
			<a href="content/weixin/user/scoreintro.htm"> <!--  <a href="javascript:void(0)"> -->
		...
		<div class="subnav" style="border-left:1px solid #eee;">
			<a href="weixin/balance/index.html"> <!-- <a href="javascript:void(0)"> -->
				<div class="icon-block">
					...
					<tbody>
						<tr>
							<td style="border:0;width:42px;"><img alt=""
								src="css/weixin/ccsjsp/user/index/changyong_add.png"></td>
						...
						<tr>
							<td style="border:0;width:42px;"><img alt=""
								src="css/weixin/ccsjsp/user/index/mine_ticket_icon.png"></td>
							<td><a href="javascript:void(0)"> <a
									href="weixin/ticket/index.html">
										<div class="list-titel no-img">
											优惠券<img alt=""
												src="css/weixin/ccsjsp/user/index/rignt_icon.png"
												class="icon-right-card">
						...
						<tr>
							<td style="border:0;width:42px;"><img alt=""
								src="css/weixin/ccsjsp/user/index/jifen_shc.png"></td>
							<td style="position:relative"><a
								href="weixin/activity/index.html">

									<div class="list-titel no-img">
										积分商城 <img alt=""
											src="css/weixin/ccsjsp/user/index/rignt_icon.png"
											class="icon-right-card">
									</div> </a> <a class="my_jifen">
									<div>
										<img alt="" src="css/weixin/ccsjsp/user/index/jifen_icon2.png">
										我的积分:${user.score}
									</div> </a>
								<div class="borderD" style=" margin-bottom: -4px;"></div></td>
						</tr>
	...
	<div class="cardexplain">
		<ul class="round operate navlist"
			...
			<li class="mobile-font">
				<table class="icardTable">
					<tbody>
						<tr>
							<td style="border:0;width:42px;"><img alt=" "
								src="css/weixin/ccsjsp/user/index/yijian_fank.png"></td>
							<td>
								<!-- <a href="javascript:void(0)">--> <a
								href="weixin/info/showaddfeedback.html">
									<div class="list-titel no-img">
										意见反馈 <img alt=""
											src="css/weixin/ccsjsp/user/index/rignt_icon.png"
											class="icon-right-card">
						...
						<tr>
							<td><img alt=""
								src="css/weixin/ccsjsp/user/index/question_icon2.png"></td>
						...
						<tr>
							<td><img alt=""
								src="css/weixin/ccsjsp/user/index/user_xieyi2.png"></td>
						...
						<tr>
							<td style="border:0;width:42px;"><img alt=""
								src="css/weixin/ccsjsp/user/index/welcome_phone.png"></td>
			...
			<li class="tel-text">
				...
				<div>
					<a href="tel:${phone}" style="color: #000; font-size: 18px;"><img
						alt="" src="css/weixin/ccsjsp/user/index/phone.png"
						style="height: 23px; vertical-align: text-bottom"> 客服热线： ${phone}</a>
				</div>
				</div>
			</li>
		</ul>
