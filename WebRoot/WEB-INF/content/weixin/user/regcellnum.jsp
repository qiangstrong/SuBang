    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td class="p10"><button id="confirmbn" class="btn-public" style="opacity:0.8" onclick="this.form.submit()">下一步</button></td>
        </tr>
      </tbody>
...
<script type="text/javascript">
  ...
  function confirmBinding(){
      ...
      $.post("weixin/user/regauthcode.html", submit_data, function (data){
         if (data.code == "err") {
           flag = 1;
         ...
         {
         flag = 1;
         window.location.href = "weixin/user/showregpassword.html";}
      },"json");
  }
</script> 
</body>
