	...
	<table align="center">
		<tr>
			<td align="right" colspan="2">
				<a href="laundry/list.html">所有商家</a>
				<a href="laundry/showadd.html">添加商家</a>
			</td>
		</tr>
		<tr>
			<td>
				<form name="searchArg" action="laundry/search.html" method="post">
					类别：
			...
			<table border="1" cellpadding="5">
					...
					<c:forEach var="laundry" items="${laundrys}">
						<tr>
							...
							<td>
								<a href="<c:url value="/laundry/showmodify.html?laundryid=${laundry.id}"/>">修改</a>
							</td>
						</tr>
					</c:forEach>
			</table>
